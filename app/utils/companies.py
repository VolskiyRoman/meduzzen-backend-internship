...
async def check_invited(action_status: InvitationStatus) -> None:
...
async def check_requested(action_status: InvitationStatus) -> None:
...
async def raise_already_in_company_exception():
    raise HTTPException(
        status_code=status.HTTP_409_CONFLICT,
